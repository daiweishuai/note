# useEffect 卸载旧值问题(闭包与 hooks 经典坑)

:::info
useRef 不仅有保存 dom 的作用，
useRef 在保存变量时，在重新渲染方法后，可以`保留`住初始值。
:::
...
<iframe src="https://daiweishuai.top/study/react/react-test/useEffect卸载旧值问题.html" width="100%" height="500px"></iframe>
